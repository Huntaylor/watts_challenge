  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= WattsChallengeBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= WattsChallengeBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= WattsChallengeBreakpoints.large) {
